...
//comandos para o modo _DEBUG
#ifdef _DEBUG
static const char VERIFICAR_LISTA_CMD	[ ] = "=verificar"		  ;
static const char VER_MEMORIA_CMD		[ ] = "=vermemoria"		  ;
...
*		
*		MODO DEBUG
*		=verificar					inxLista	CondRetEsp
*		=deturpar					inxLista	CondRetEsp Modo
*		=vermemoria				
***********************************************************************/
...
/* Testar Verificar Lista, só para modo _DEBUG */
         ...
         else if ( strcmp( ComandoTeste , VERIFICAR_LISTA_CMD ) == 0 )
         {
			...
			return TST_CompararInt( CondRetEsp ,
                      ...
                      "Verificação não condiz com esperado" ) ;

         } 
		 
#endif

		 /* fim ativa: verificar lista */
		   ...
		   else if ( strcmp( ComandoTeste , DETURPAR_CMD ) == 0 )
         {
			...
			return TST_CompararInt( CondRetEsp ,
                      LIS_DeturparLista( vtListas[ inxLista ], modo) ,
                      "Não foi possível deturpar a lista do modo preterido" ) ;

            

         } /* fim ativa: deturpar lista */
