...
Módulo de Definição: BAR módulo baralho

arquivo gerado:BARALHO.h
letras identificadoras: BAR

Para o trabalho T2 da disciplina Programação Modular na PUC-RIO, professor Alessandro. 2016.1

Autores: André, Danillo e Albert
Descrição do módulo:
	O módulo implementa utilidades de baralho que podem ser utilizadas para jogos de cartas. São definidos os tipos: 'carta' e 'baralho', e 
	funções para manipulá-los.
	O módulo usa os módulos lista duplamente encadeada( LISTA.h) e gerador de aleatórios (GERAALT.h)
